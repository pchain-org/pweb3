...
export class Pi extends AbstractWeb3Module {
    ...
    getFullBalance(address: string): Promise<string>;
    getFullBalance(address: string, defaultBlock: string | number): Promise<string>;
    getFullBalance(address: string, callback?: (error: Error, result: string) => void): Promise<string>;
    getFullBalance(address: string, defaultBlock: string | number, callback?: (error: Error, result: string) => void): Promise<string>;
