...
// del
export CheckCandidateMethod from './methods/del/CheckCandidateMethod';
export DelegateMethod from './methods/del/DelegateMethod';
export CancelDelegateMethod from './methods/del/CancelDelegateMethod';
export ApplyCandidateMethod from './methods/del/ApplyCandidateMethod';
export CancelCandidateMethod from './methods/del/CancelCandidateMethod';

// chain
export CreateChildChainMethod from './methods/chain/CreateChildChainMethod';
export JoinChildChainMethod from './methods/chain/JoinChildChainMethod';
export DepositInMainChainMethod from './methods/chain/DepositInMainChainMethod';
export DepositInChildChainMethod from './methods/chain/DepositInChildChainMethod';
export WithdrawFromChildChainMethod from './methods/chain/WithdrawFromChildChainMethod';
export WithdrawFromMainChainMethod from './methods/chain/WithdrawFromMainChainMethod';
export SignAddressMethod from './methods/chain/SignAddressMethod';
export SetBlockRewardMethod from './methods/chain/SetBlockRewardMethod';
export GetBlockRewardMethod from './methods/chain/GetBlockRewardMethod';
export GetAllChainsMethod from './methods/chain/GetAllChainsMethod';

// tdm
export VoteNextEpochMethod from './methods/tdm/VoteNextEpochMethod';
export RevealVoteMethod from './methods/tdm/RevealVoteMethod';
export GetCurrentEpochNumberMethod from './methods/tdm/GetCurrentEpochNumberMethod';
export GetEpochMethod from './methods/tdm/GetEpochMethod';
export GetNextEpochVoteMethod from './methods/tdm/GetNextEpochVoteMethod';
export GetNextEpochValidatorsMethod from './methods/tdm/GetNextEpochValidatorsMethod';
export GeneratePrivateValidatorMethod from './methods/tdm/GeneratePrivateValidatorMethod';
...
export GetFullBalanceMethod from './methods/account/GetFullBalanceMethod';
